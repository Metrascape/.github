...
- **Metrascape Scout** — an AI assistant (Anthropic Claude) that helps contractors find materials, compare options, and move toward checkout through natural conversation.
...
| Repo | Purpose |
|------|---------|
| [`metrascape-app`](https://github.com/Metrascape/metrascape-app) | Web and mobile client — React + Vite frontend, Capacitor native shell |
| [`tradeyard-docs`](https://github.com/Metrascape/tradeyard-docs) | Architecture decision records, specs, runbooks, and partner documentation |

---

[metrascape.com](https://metrascape.com)
